...
//  My-Mo
//
//  Created by iDeveloper on 11/2/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let strLogined: String = DATAKEEPER.getLogined()
        if (strLogined != "" && strLogined == "yes"){
            USER.getUserDataWithUserDefault()
            
            let viewController = self.window?.rootViewController?.storyboard?.instantiateViewController(withIdentifier: "TapBarView") as! TabBarViewController
...
/*
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "My_Mo")
